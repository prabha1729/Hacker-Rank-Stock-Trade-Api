...
@Component
class DemoRunnner implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		User u1 = new User((long) 1, "Briana Ortiz");
		User u2 = new User((long) 2, "Amy Palmer");
//		userRepository.saveAll(Arrays.asList(u1,u2));
		Trade t1 = new Trade("buy", u2, "AA", 11, (float) 174.82, Timestamp.valueOf("2018-12-28 13:18:48"));
		Trade t2 = new Trade("buy", u2, "AA", 11, (float) 174.82, Timestamp.valueOf("2018-12-29 09:47:43"));
		Trade t3 = new Trade("buy", u1, "A", 20, (float) 155.32, Timestamp.valueOf("2019-01-01 11:19:01"));
		...
		Trade t6 = new Trade("buy", u1, "A", 20, (float) 155.32, Timestamp.valueOf("2019-01-02 15:42:18"));
